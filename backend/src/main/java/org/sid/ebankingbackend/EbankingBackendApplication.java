...
public class EbankingBackendApplication {
    ...
    CommandLineRunner commandLineRunner(BankAccountService bankAccountService){
        return args -> {
           Stream.of("Mohamed","Tarik","Brahim").forEach(name->{
           ...
           bankAccountService.listCustomers().forEach(customer->{
               try {
                   bankAccountService.saveCurrentBankAccount(Math.random()*70000,6000,customer.getId());
                   bankAccountService.saveSavingBankAccount(Math.random()*100000,1.4,customer.getId());
            ...
            for (BankAccountDTO bankAccount:bankAccounts){
                for (int i = 0; i <10 ; i++) {
                    ...
                    bankAccountService.debit(accountId,Math.random()*9000,"Debit");
                }
            }
        };
    }
    ...
    CommandLineRunner start(CustomerRepository customerRepository,
        ...
        return args -> {
            Stream.of("Mifdal Mohamed","khalid Tarab","Nadi Hassan ").forEach(name->{
